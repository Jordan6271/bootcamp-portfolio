...
const introText = `This project has been my favourite one so far through the
...
const difficultyText = ` I hadn't done a lot using JavaScript before starting this
...
to an inventory array appended to the "Player" class.`;

const progressionText = `Every hurdle I eventually got over was a significant measure
...
const links = {
    ghPages: `https://jordan6271.github.io/bootcamp-project-week5/`,
    repo: `https://github.com/Jordan6271/bootcamp-project-week5`,
};
